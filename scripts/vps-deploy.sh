...
# --- 11. Post-deploy cleanup (non-fatal, best effort) ---
# Runs only after step 8 confirmed the new service is active. Bounds disk growth
...
# slovo-landing:latest is retagged) and caps the buildx builder cache.
