...
- Natural-sort screenshots gallery (client collator + sort -V in refresh)
...
- Wire DOCS_HOSTNAME through the hostname-baking pipeline
...
- Reliable CTA icon swap on iOS/desktop and meta copy for web version
...
[0.8.1]: https://git.lightnode.ru/Slovo_Propovedi/slovo-propovedi-landing/src/tag/v0.8.1
...
[0.6.1]: https://git.lightnode.ru/Slovo_Propovedi/slovo-propovedi-landing/src/tag/v0.6.1
[0.6.0]: https://git.lightnode.ru/Slovo_Propovedi/slovo-propovedi-landing/src/tag/v0.6.0
[0.5.1]: https://git.lightnode.ru/Slovo_Propovedi/slovo-propovedi-landing/src/tag/v0.5.1
